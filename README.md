# Friday Night Funkin' - ALE Engine (W.I.P.)

>[!IMPORTANT]
> ## This engine is still in **Alpha State**
> * Mods created in **Psych Engine 0.7.3** are compatible with **ALE Engine** (For now)
...
## ALE Engine
**ALE Engine** is a new **Friday Night Funkin' Engine** based on **Psych Engine** *(currently in version 0.7.3)* originally used for [Weekend Afternoon Extended (WIP)](https://gamebanana.com/mods/379624), intended to be **easier to use** in **some aspects** and **improve others**, as well as **improve performance**.
