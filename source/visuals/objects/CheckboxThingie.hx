...
class CheckboxThingie extends FlxSprite
{
	...
	public function new(x:Float = 0, y:Float = 0, ?checked = false) {
		...
		animation.addByPrefix("unchecked", "finish", 24, false);
		animation.addByPrefix("unchecking", "false", 24, false);
		animation.addByPrefix("checking", "true", 24, false);
		animation.addByPrefix("checked", "start", 24, false);
