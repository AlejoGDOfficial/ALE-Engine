...
class ScriptState extends MusicBeatState
{
    ...
    private var luaDebugGroup:FlxTypedGroup<scripting.menus.DebugLuaText>;
    #end
    ...
    override public function create()
    {
		...
		#if (LUA_ALLOWED || HSCRIPT_ALLOWED)
		luaDebugGroup = new FlxTypedGroup<scripting.menus.DebugLuaText>();
		add(luaDebugGroup);
		#end
    ...
    {
        var newText:scripting.menus.DebugLuaText = luaDebugGroup.recycle(scripting.menus.DebugLuaText);
        newText.text = text;
        newText.color = color;
        ...
        luaDebugGroup.forEachAlive(function(spr:scripting.menus.DebugLuaText) {
	...
	public function switchToSomeStates(state:String)
	{
		switch (state)
		{
			...
			case 'states.editors.CharacterEditorState':
				LoadingState.loadAndSwitchState(new states.editors.CharacterEditorState(Character.DEFAULT_CHARACTER, false));
			...
			case 'states.editors.NoteSplashDebugState':
				MusicBeatState.switchState(new states.editors.NoteSplashDebugState());
		}
	}
