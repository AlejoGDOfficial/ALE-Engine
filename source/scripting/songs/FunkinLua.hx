...
import scripting.songs.LuaUtils.LuaTweenOptions;
#if SScript
import scripting.songs.HScript;
#end
import scripting.songs.DebugLuaText;
...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		set('rating', 0);
		set('ratingName', '');
		set('version', CoolVars.globalVars.get('engineVersion'));
