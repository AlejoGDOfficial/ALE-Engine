...
class ReflectionFunctions
{
	...
	public static function implement(funk:FunkinLua)
	{
		...
		Lua_helper.add_callback(lua, "createInstance", function(variableToSave:String, className:String, ?args:Array<Dynamic> = null) {
			...
			if(!ScriptState.instance.variables.exists(variableToSave))
			{
				if(args == null) args = [];
				...
				if(obj != null)
					ScriptState.instance.variables.set(variableToSave, obj);
				else
		...
		Lua_helper.add_callback(lua, "addInstance", function(objectName:String, ?inFront:Bool = false) {
			if(ScriptState.instance.variables.exists(objectName))
			{
				var obj:Dynamic = ScriptState.instance.variables.get(objectName);
				
				ScriptState.instance.add(obj);
			}
