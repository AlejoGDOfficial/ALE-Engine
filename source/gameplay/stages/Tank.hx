...
class Tank extends BaseStage
{
	...
	override function create()
	{
		...
		if(!ClientPrefs.getJsonPref('lowQuality'))
		{
		...
		if(!ClientPrefs.getJsonPref('lowQuality')) foregroundSprites.add(new BGSprite('tank1', -300, 750, 2, 0.2, ['fg']));
		foregroundSprites.add(new BGSprite('tank2', 450, 940, 1.5, 1.5, ['foreground']));
		if(!ClientPrefs.getJsonPref('lowQuality')) foregroundSprites.add(new BGSprite('tank4', 1300, 900, 1.5, 1.5, ['fg']));
		foregroundSprites.add(new BGSprite('tank5', 1620, 700, 1.5, 1.5, ['fg']));
		if(!ClientPrefs.getJsonPref('lowQuality')) foregroundSprites.add(new BGSprite('tank3', 1300, 1200, 3.5, 2.5, ['fg']));
	...
	{
		if(!ClientPrefs.getJsonPref('lowQuality')) tankWatchtower.dance();
	...
	function prepareCutscene()
	{
		...
		tankman.antialiasing = ClientPrefs.getJsonPref('antiAliasing');
	...
	function stressIntro()
	{
		...
		pico.antialiasing = ClientPrefs.getJsonPref('antiAliasing');
		...
		boyfriendCutscene.antialiasing = ClientPrefs.getJsonPref('antiAliasing');
