...
class CSVReader {
    ...
    */
    public function open(?string:String, ?stream:Input):CSVReader
    {
    ...
    */
    ...
    public inline function reset(?string:String, ?stream:Input):CSVReader
    {
    ...
    */
    ...
    /*
       ...
       Part of the iterator/iterable interface.
    */
    public function iterator():CSVReader
    {
        return this;
    }
    ...
    */
    public static function readCsv(stream:Input, ?separator, ?escape, ?endOfLine:Array<String>):CSVReader
    {
        var p = new CSVReader(separator, escape, endOfLine);
        p.inp = stream;
        return p;
    }
    ...
    */
    public static function parseCsv(text:String, ?separator, ?escape, ?endOfLine:Array<String>):Array<CSVRecord>
    {
        var p = new CSVReader(separator, escape, endOfLine);
        p.buffer = text;
        return p.readAll();
    ...
    */
    ...
    public static inline function read(text:String, ?separator, ?escape, ?endOfLine:Array<String>):Array<CSVRecord>
    {
