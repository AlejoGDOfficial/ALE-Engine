...
class CSVUtf8Reader extends CSVReader {
    ...
    */
    public static function readCsv(stream:Input, ?separator, ?escape, ?endOfLine:Array<String>):CSVUtf8Reader
    {
        var p = new CSVUtf8Reader(separator, escape, endOfLine);
        p.inp = stream;
        return p;
    }
