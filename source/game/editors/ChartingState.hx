...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Change Camera Modulo', 'Sets how often the camera/UI zooms (in beats)\n\nValue 1: Camera Modulo\nValue 2: UI Modulo'],
		['Change Icons Modulo', 'Sets how often the icons zoom (in beats)\n\nValue 1: Icons Modulo'],
	...
	**/
	...
	function addSongUI():Void
	{
		...
		#if MODS_ALLOWED
		var directories:Array<String> = [Paths.mods(Mods.currentModDirectory + '/characters/'), Paths.getSharedPath('characters/')];
		#else
		...
		#if MODS_ALLOWED
		var directories:Array<String> = [Paths.mods(Mods.currentModDirectory + '/stages/'), Paths.getSharedPath('stages/')];
		#else
	...
	override function update(elapsed:Float)
	{
		...
		if (!blockInput)
		{
			if (FlxG.keys.justPressed.ESCAPE)
			{
				...
				openSubState(new game.editors.EditorPlayState(playbackSpeed));
			}
