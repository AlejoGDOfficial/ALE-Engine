...
class ClientPrefs {
	...
	{
		final emptyArray = [];
		FlxG.sound.muteKeys = turnOn ? CoolVars.muteKeys : emptyArray;
		FlxG.sound.volumeDownKeys = turnOn ? CoolVars.volumeDownKeys : emptyArray;
		FlxG.sound.volumeUpKeys = turnOn ? CoolVars.volumeUpKeys : emptyArray;
	}
}
