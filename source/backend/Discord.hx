...
class DiscordClient
{
	...
	private inline static final _defaultID:String = "1309982575368077416";
	...
	public static function changePresence(details:String = '', ?state:String, ?smallImageKey:String, ?hasStartTimestamp:Bool, ?endTimestamp:Float, largeImageKey:String = 'icon')
	{
		...
		presence.largeImageText = "Engine Version: " + CoolVars.globalVars.get('engineVersion');
