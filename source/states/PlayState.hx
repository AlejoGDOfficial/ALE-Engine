...
class PlayState extends MusicBeatState
{
	...
	{
		callOnScripts('onUpdateIconsScale', [elapsed]);
	}

	public dynamic function updateIconsPosition()
	{
		callOnScripts('onUpdateIconsPosition');
	}
	...
	private function cachePopUpScore()
	{
		...
		for (rating in ratingsData)
			Paths.image(uiPrefix + rating.image + uiSuffix + LanguageManager.getSuffix());
		for (i in 0...10)
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		rating.loadGraphic(Paths.image(uiPrefix + daRating.image + uiSuffix + LanguageManager.getSuffix()));
		rating.screenCenter();
		...
		var comboSpr:FlxSprite = new FlxSprite().loadGraphic(Paths.image(uiPrefix + 'combo' + uiSuffix + LanguageManager.getSuffix()));
