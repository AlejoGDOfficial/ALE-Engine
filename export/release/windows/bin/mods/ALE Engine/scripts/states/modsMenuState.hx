...
function changeSelectedMod(add:Int, isMouseWheel:Bool)
{
...
var selectBg:FlxSprite;
var icon:FlxSprite;
var text:FlxText;
var totalFrames:Int = 0;

// options
var name:String = 'Unknown Mod';
var desc:String = 'No description provided.';
var iconFps:Int = 10;
var bgColor:FlxColor = 0xFF665AFF;
var pack:Dynamic = null;
var folder:String = 'unknownMod';
var mustRestart:Bool = false;
var settings:Array<Dynamic> = null;

function new(folder:String)
{
	super();
...
var bg:FlxSprite;
var textOn:Alphabet;
var textOff:Alphabet;
var icon:FlxSprite;
var onClick:Void->Void = null;
var enabled:Bool = true;
function new(x:Float, y:Float, width:Int, height:Int, ?text:String = null, ?img:FlxGraphic = null, onClick:Void->Void = null, animWidth:Int = 0, animHeight:Int = 0)
{
	super(x, y);
...
var focusChangeCallback:Bool->Void = null;
...
function centerOnBg(spr:FlxSprite)
{
